...
public class ChunkDataPacketEvent262 extends Event implements Cancellable {
    ...
    public ChunkDataPacketEvent262(Player player, boolean async, int chunkX, int chunkZ) {
        super(async);
        this.player = player;
