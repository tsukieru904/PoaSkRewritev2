...
public class TeamPacket262 {
    ...
    public static Object teamPacket(String teamName, String displayName, String nameTagVisibility, String collision, String color, String prefix, String suffix, boolean seeFriendly, Collection<String> players) {
        try {
            ...
            playerTeam.setColor(Optional.of(TeamColor.valueOf(color.toUpperCase())));
            playerTeam.setPlayerPrefix(Components262.nmsComponentActual(MiniMessage.miniMessage().deserialize(prefix)));
            playerTeam.setPlayerSuffix(Components262.nmsComponentActual(MiniMessage.miniMessage().deserialize(suffix)));
            ...
            playerTeam.setDisplayName(Components262.nmsComponentActual(MiniMessage.miniMessage().deserialize(displayName)));
